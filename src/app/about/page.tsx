  ...
  return (
    <Container as="section" className="py-8 md:py-12 max-w-3xl">
      ...
      <div className="space-y-5 text-foreground/90 text-base md:text-lg leading-relaxed">
        ...
        <p>
          When life got heavy&mdash;and <em>it did</em>&mdash;I found myself often turning to Spider-Man comics. Not because they had all the answers, but because Peter Parker never gave up. No matter how bad things got, no matter how much the world pushed back, he kept swinging. That resilience became something I needed to see, over and over again.
        </p>
        <p>
          <strong className="text-foreground">The Spidaverse</strong> is my way of paying that forward. It&rsquo;s where I share the movies, games, anime, manga, and music that got me through&mdash;and continue to get me through. Every piece of media gets a <strong className="text-foreground">Web Rating</strong> out of 100, visualized as a spider web that fills based on the score. Not because I want to debate whether something deserves an 87 or a 91, but because sometimes you just need to quantify how much something mattered to you. The emphasis being that these things connect us to one another.
        </p>
        <p>
          I&rsquo;m not here to prove anything right or wrong. I&rsquo;m not here to win arguments in the comments (the internet&rsquo;s already got enough of that). I&rsquo;m just here to nerd out with you about the stuff we love. To share why a &ldquo;bad&rdquo; movie hit different for me. To put you on to that J-Pop/Rap artist you&rsquo;ve been sleeping on. To defend <em>Batman v Superman</em> against all odds (yes, really).
        </p>
        <p>
