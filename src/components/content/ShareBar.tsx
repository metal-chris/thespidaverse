    ...
    >
      {shareLinks.map((link) => (
        <a
          ...
          className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-md text-muted-foreground hover:text-accent hover:bg-muted transition-colors"
      ...
      {"share" in (typeof navigator !== "undefined" ? navigator : {}) && (
        <button
          ...
          className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-md text-muted-foreground hover:text-accent hover:bg-muted transition-colors md:hidden"
          aria-label="Share"
          title="Share"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2}>
